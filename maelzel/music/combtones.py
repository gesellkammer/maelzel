...
def difftone_sources_in_range(difftone: pitch_t, minnote:pitch_t=None,
                              maxnote:pitch_t= "D8", resolution=0.5, maxinterval=7.) -> List[Difftone]:
    """
...
def _checkpitch(p: U[str, int, float]) -> bool:
    if isinstance(p, str):
        return True
