...
def _mergeAcrossBeats(groups: list[DurationGroup],
    ...
    Args:
        groups: a list of duration groups, as returned by QuantizedMeasure.beatGroups
    ...
    # groups after merging across beats.
...
def _mergeNotationsAcrossBeats(notations: list[Notation],
    ...
    Returns:
        a list of merged notations. These notations are flat but the groups can be reconstructed based
...
class GroupStack:
    ...
    def __repr__(self):
        return f"GroupStack(ratios={self.ratios}, groups={self.groups})"
