...
class OfflineRenderer(renderer.Renderer):
    ...
    def play(self, obj: mobj.MObj, **kws) -> csoundengine.offline.EventGroup:
        """
    ...
    def schedEvents(self,
                    ...
                    ) -> csoundengine.offline.EventGroup:
        """
        ...
        Returns:
            a :class:`csoundengine.offline.EventGroup`. This can be used to modify
...
def render(outfile: str = None,
           events: list[SynthEvent | mobj.MObj | list[mobj.MObj | SynthEvent]] = None,
           sr: int = None,
           wait: bool = None,
           ksmps: int = None,
           quiet: bool = None,
